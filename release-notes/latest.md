# DMT 2.6.2 Release Notes

DMT 2.6.2 adds reusable custom colour operators and a continuous, brightness-linked Perception Map. It also improves editing and navigation, reduces interface delays, and fixes issues with theme loading, font installation, and history storage.
